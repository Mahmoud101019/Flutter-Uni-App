...
class PHARMACYAhramScreen extends StatefulWidget {
  PHARMACYAhramScreen({super.key});

  @override
  State<PHARMACYAhramScreen> createState() => _PHARMACYAhramScreenState();
}

class _PHARMACYAhramScreenState extends State<PHARMACYAhramScreen> {
  List<Map> ADSlider = [
    {"id": 1, "ImagePath": 'assets/images/pahram.png'},
    {"id": 2, "ImagePath": 'assets/images/pahram1.png'},
    {"id": 3, "ImagePath": 'assets/images/pahram2.png'},
  ];
              ...
              children: [
                ...
                Container(
                  ...
                  child: AuthButton(
                    text: "Apply Now",
                    onPressed: () {
                      Get.toNamed(Routes.AplyyPHARMACYAhramScreen);
                    },
                  ),
                ),
                SizedBox(
