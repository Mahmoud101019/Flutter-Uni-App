...
class AplyyPHARMACYAhram3Screen extends StatelessWidget {
  const AplyyPHARMACYAhram3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of PHARMACY"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyPHARMACYAhram3Screen);
                        },
                        onConfirm: () {
