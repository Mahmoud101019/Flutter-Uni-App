...
class AplyyPHARMACYAhram2Screen extends StatefulWidget {
  AplyyPHARMACYAhram2Screen({super.key});

  @override
  State<AplyyPHARMACYAhram2Screen> createState() => _AplyyPHARMACYAhram2ScreenState();
}

class _AplyyPHARMACYAhram2ScreenState extends State<AplyyPHARMACYAhram2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyPHARMACYAhram3Screen);
                              }
                            }),
                      ),
                      SizedBox(
