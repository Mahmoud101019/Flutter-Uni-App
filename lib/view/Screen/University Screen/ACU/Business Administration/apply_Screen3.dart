...
class AplyyBUSINESSAhram3Screen extends StatelessWidget {
  const AplyyBUSINESSAhram3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("BUSINESS ADMINISTRATION"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyBUSINESSAhram3Screen);
                        },
                        onConfirm: () {
