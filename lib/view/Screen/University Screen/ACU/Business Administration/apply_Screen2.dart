...
class AplyyBUSINESSAhram2Screen extends StatefulWidget {
  AplyyBUSINESSAhram2Screen({super.key});

  @override
  State<AplyyBUSINESSAhram2Screen> createState() => _AplyyBUSINESSAhram2ScreenState();
}

class _AplyyBUSINESSAhram2ScreenState extends State<AplyyBUSINESSAhram2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyBUSINESSAhram3Screen);
                              }
                            }),
                      ),
                      SizedBox(
