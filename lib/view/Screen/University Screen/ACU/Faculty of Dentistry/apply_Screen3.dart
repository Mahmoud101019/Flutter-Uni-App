...
class AplyyDENTISTRYAhram3Screen extends StatelessWidget {
  const AplyyDENTISTRYAhram3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of DENTISTRY"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyDENTISTRYAhram3Screen);
                        },
                        onConfirm: () {
