...
class AplyyDENTISTRYAhram2Screen extends StatefulWidget {
  AplyyDENTISTRYAhram2Screen({super.key});

  @override
  State<AplyyDENTISTRYAhram2Screen> createState() => _AplyyDENTISTRYAhram2ScreenState();
}

class _AplyyDENTISTRYAhram2ScreenState extends State<AplyyDENTISTRYAhram2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyDENTISTRYAhram3Screen);
                              }
                            }),
                      ),
                      SizedBox(
