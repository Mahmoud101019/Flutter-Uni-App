...
class AplyyBusinessAuC2Screen extends StatefulWidget {
  AplyyBusinessAuC2Screen({super.key});

  @override
  State<AplyyBusinessAuC2Screen> createState() => _AplyyBusinessAuC2ScreenState();
}

class _AplyyBusinessAuC2ScreenState extends State<AplyyBusinessAuC2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyBusinessAuC3Screen);
                              }
                            }),
                      ),
                      SizedBox(
