...
class HssAucScreen extends StatefulWidget {
  HssAucScreen({super.key});

  @override
  State<HssAucScreen> createState() => _HssAucScreenState();
}

class _HssAucScreenState extends State<HssAucScreen> {
  List<Map> ADSlider = [
    {"id": 1, "ImagePath": 'assets/images/hss.png'},
    {"id": 2, "ImagePath": 'assets/images/hss1.png'},
    {"id": 3, "ImagePath": 'assets/images/hss2.png'},
  ];
              ...
              children: [
                ...
                Container(
                  ...
                  child: AuthButton(
                    text: "Apply Now",
                    onPressed: () {
                      Get.toNamed(Routes.AplyyHssAucScreen);
                    },
                  ),
                ),
                SizedBox(
