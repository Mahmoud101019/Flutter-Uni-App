...
class AplyyHssAuc2Screen extends StatefulWidget {
  AplyyHssAuc2Screen({super.key});

  @override
  State<AplyyHssAuc2Screen> createState() => _AplyyHssAuc2ScreenState();
}

class _AplyyHssAuc2ScreenState extends State<AplyyHssAuc2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyHssAuc3Screen);
                              }
                            }),
                      ),
                      SizedBox(
