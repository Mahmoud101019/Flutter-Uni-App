...
class AplyyGlobalAffairs2Screen extends StatefulWidget {
  AplyyGlobalAffairs2Screen({super.key});

  @override
  State<AplyyGlobalAffairs2Screen> createState() => _AplyyGlobalAffairs2ScreenState();
}

class _AplyyGlobalAffairs2ScreenState extends State<AplyyGlobalAffairs2Screen> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextUtils(
                            fontSize: 25,
                            fontWeight: FontWeight.bold,
                            text: "Faculty of Global Affairs In AUC",
                            color: Colors.black,
                            underLine: TextDecoration.none),
                      ),
                      SizedBox(
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyGlobalAffairs3Screen);
                              }
                            }),
                      ),
                      SizedBox(
