...
class AplyyGlobalAffairs3Screen extends StatelessWidget {
  const AplyyGlobalAffairs3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of Global Affairs"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyGlobalAffairs3Screen);
                        },
                        onConfirm: () {
