// ignore_for_file: file_names, prefer_const_constructors_in_immutables, prefer_const_constructors, unused_import, unused_local_variable, prefer_const_literals_to_create_immutables, camel_case_types
...
class computerAplyyScreen extends StatelessWidget {
  computerAplyyScreen({super.key});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AuthButton(
                            text: "Apply",
                            onPressed: () {
                              Get.toNamed(Routes.computerAplyy2Screen);
                            }),
                      )
                    ],
                  ),
