...
class computerscienceScreen extends StatefulWidget {
  computerscienceScreen({super.key});
...
class _computerscienceScreenState extends State<computerscienceScreen> {
  ...
  List<Map> ADSlider = [
    {"id": 1, "ImagePath": 'assets/images/cs1.png'},
    {"id": 2, "ImagePath": 'assets/images/cs2.png'},
    {"id": 3, "ImagePath": 'assets/images/cs3.png'},
  ];
            ...
            child: Column(
              children: [
                ...
                TextUtils(
                  ...
                  fontSize: 18.sp,
                  fontWeight: FontWeight.w900,
                  text: "Faculty of Informatics & Computer Science",
                  underLine: TextDecoration.none,
                ),
                SizedBox(
                  height: 2.h,
                ...
                Container(
                  ...
                  child: AuthButton(
                    text: "Apply Now",
                    onPressed: () {
                      Get.toNamed(Routes.computerAplyyScreen);
                    },
                  ),
                ),
                SizedBox(
