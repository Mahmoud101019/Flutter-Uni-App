// ignore_for_file: file_names, prefer_const_constructors_in_immutables, prefer_const_constructors, unused_import, unused_local_variable, prefer_const_literals_to_create_immutables, non_constant_identifier_names, prefer_typing_uninitialized_variables, sort_child_properties_last, camel_case_types
...
class computerAplyy2Screen extends StatefulWidget {
  computerAplyy2Screen({super.key});

  @override
  State<computerAplyy2Screen> createState() => _computerAplyy2ScreenState();
}

class _computerAplyy2ScreenState extends State<computerAplyy2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.computerAplyy3Screen);
                              }
                            }),
                      ),
                      SizedBox(
