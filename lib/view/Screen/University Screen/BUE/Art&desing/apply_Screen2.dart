...
class AplyyArt2Screen extends StatefulWidget {
  AplyyArt2Screen({super.key});

  @override
  State<AplyyArt2Screen> createState() => _AplyyArt2ScreenState();
}

class _AplyyArt2ScreenState extends State<AplyyArt2Screen> {
