...
class AplyyEngineeringTechnology3Screen extends StatelessWidget {
  const AplyyEngineeringTechnology3Screen({super.key});
  @override
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyEngineeringTechnology3Screen);
                        },
                        onConfirm: () {
