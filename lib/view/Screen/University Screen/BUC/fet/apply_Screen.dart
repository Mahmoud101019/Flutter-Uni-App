...
class AplyyEngineeringTechnologyScreen extends StatelessWidget {
  AplyyEngineeringTechnologyScreen({super.key});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AuthButton(
                            text: "Apply",
                            onPressed: () {
                              Get.toNamed(Routes.AplyyEngineeringTechnology2Screen);
                            }),
                      )
                    ],
                  ),
