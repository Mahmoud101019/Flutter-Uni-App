...
class AplyyBusinessScreen extends StatelessWidget {
  AplyyBusinessScreen({super.key});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextUtils(
                            fontSize: 25,
                            fontWeight: FontWeight.bold,
                            text: "Business and Economics In Badr Uni.",
                            color: Colors.black,
                            underLine: TextDecoration.none),
                      ),
                      SizedBox(
                      ...
                      Container(
                        ...
                        child: AuthButton(
                            text: "Apply",
                            onPressed: () {
                              Get.toNamed(Routes.AplyyBusiness2Screen);
                            }),
                      )
                    ],
                  ),
