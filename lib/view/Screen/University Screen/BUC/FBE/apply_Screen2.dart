...
class AplyyBusiness2Screen extends StatefulWidget {
  AplyyBusiness2Screen({super.key});

  @override
  State<AplyyBusiness2Screen> createState() => _AplyyBusiness2ScreenState();
}

class _AplyyBusiness2ScreenState extends State<AplyyBusiness2Screen> {
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextUtils(
                            fontSize: 25,
                            fontWeight: FontWeight.bold,
                            text: "Business and Economics In BUC",
                            color: Colors.black,
                            underLine: TextDecoration.none),
                      ),
                      SizedBox(
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyBusiness3Screen);
                              }
                            }),
                      ),
                      SizedBox(
