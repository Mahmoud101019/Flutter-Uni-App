...
class _MedicineScreenState extends State<MedicineScreen> {
  List<Map> ADSlider = [
    {"id": 1, "ImagePath": 'assets/images/me.png'},
    {"id": 2, "ImagePath": 'assets/images/me1.png'},
    {"id": 3, "ImagePath": 'assets/images/me2.png'},
  ];
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextUtils(
                    ...
                    text:
                        "Our new school strives to position itself at the forefront of the challenges of significant transformation in medical education. We offer an innovative curriculum addressing the academic requirements of physicians for future medical practice. Our medical program utilizes a competency-based curriculum focusing on best practices in patient care, delivered through innovative teaching strategies; a digital classroom, an advanced simulation center, a comprehensive library, and streamlined integrated courses ensuring a seamless transition from basic to clinical science applications.",
                    underLine: TextDecoration.none,
                  ),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: AuthButton(
                    text: "Apply Now",
                    onPressed: () {
                      Get.toNamed(Routes.AplyyMedicineScreen);
                    },
                  ),
                ),
                SizedBox(
