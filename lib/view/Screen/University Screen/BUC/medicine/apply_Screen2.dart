...
class AplyyMedicine2Screen extends StatefulWidget {
  AplyyMedicine2Screen({super.key});

  @override
  State<AplyyMedicine2Screen> createState() => _AplyyMedicine2ScreenState();
}

class _AplyyMedicine2ScreenState extends State<AplyyMedicine2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyMedicine3Screen);
                              }
                            }),
                      ),
                      SizedBox(
