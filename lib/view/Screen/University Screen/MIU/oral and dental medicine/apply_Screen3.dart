...
class AplyyOralanddentalMIU3Screen extends StatelessWidget {
  const AplyyOralanddentalMIU3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of Oral and Dental"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyOralanddentalMIU3Screen);
                        },
                        onConfirm: () {
