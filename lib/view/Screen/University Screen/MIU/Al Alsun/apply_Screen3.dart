...
class AplyyAlsunMIU3Screen extends StatelessWidget {
  const AplyyAlsunMIU3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of Al Alsun"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyAlsunMIU3Screen);
                        },
                        onConfirm: () {
