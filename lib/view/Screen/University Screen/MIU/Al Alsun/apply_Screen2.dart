...
class AplyyAlsunMIU2Screen extends StatefulWidget {
  AplyyAlsunMIU2Screen({super.key});

  @override
  State<AplyyAlsunMIU2Screen> createState() => _AplyyAlsunMIU2ScreenState();
}

class _AplyyAlsunMIU2ScreenState extends State<AplyyAlsunMIU2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyAlsunMIU3Screen);
                              }
                            }),
                      ),
                      SizedBox(
