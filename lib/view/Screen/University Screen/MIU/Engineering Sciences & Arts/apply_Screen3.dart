...
class AplyyEngineeringMIU3Screen extends StatelessWidget {
  const AplyyEngineeringMIU3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Faculty of Engineering Sciences & Arts"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyEngineeringMIU3Screen);
                        },
                        onConfirm: () {
