...
class CSBHTIcreen extends StatefulWidget {
  CSBHTIcreen({super.key});

  @override
  State<CSBHTIcreen> createState() => _CSBHTIcreenState();
}

class _CSBHTIcreenState extends State<CSBHTIcreen> {
  List<Map> ADSlider = [
              ...
              children: [
                ...
                Container(
                  ...
                  child: AuthButton(
                    text: "Apply Now",
                    onPressed: () {
                      Get.toNamed(Routes.AplyyCSBHTIcreen);
                    },
                  ),
                ),
                SizedBox(
