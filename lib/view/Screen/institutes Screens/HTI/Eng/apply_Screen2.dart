...
class AplyyEngBHTI2creen extends StatefulWidget {
  AplyyEngBHTI2creen({super.key});

  @override
  State<AplyyEngBHTI2creen> createState() => _AplyyEngBHTI2creenState();
}

class _AplyyEngBHTI2creenState extends State<AplyyEngBHTI2creen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyEngBHTI3creen);
                              }
                            }),
                      ),
                      SizedBox(
