...
class AplyyBusinessBHTI2creen extends StatefulWidget {
  AplyyBusinessBHTI2creen({super.key});

  @override
  State<AplyyBusinessBHTI2creen> createState() => _AplyyBusinessBHTI2creenState();
}

class _AplyyBusinessBHTI2creenState extends State<AplyyBusinessBHTI2creen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyBusinessBHTI3creen);
                              }
                            }),
                      ),
                      SizedBox(
