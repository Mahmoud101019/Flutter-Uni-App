...
class AplyyCSfuture2Screen extends StatefulWidget {
  AplyyCSfuture2Screen({super.key});

  @override
  State<AplyyCSfuture2Screen> createState() => _AplyyCSfuture2ScreenState();
}

class _AplyyCSfuture2ScreenState extends State<AplyyCSfuture2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyCSfuture3Screen);
                              }
                            }),
                      ),
                      SizedBox(
