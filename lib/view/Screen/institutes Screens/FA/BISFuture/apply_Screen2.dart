...
class AplyyBISfuture2Screen extends StatefulWidget {
  AplyyBISfuture2Screen({super.key});

  @override
  State<AplyyBISfuture2Screen> createState() => _AplyyBISfuture2ScreenState();
}

class _AplyyBISfuture2ScreenState extends State<AplyyBISfuture2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyBISfuture3Screen);
                              }
                            }),
                      ),
                      SizedBox(
