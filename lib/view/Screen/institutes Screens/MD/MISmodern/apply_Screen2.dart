...
class AplyyMISModern2Screen extends StatefulWidget {
  AplyyMISModern2Screen({super.key});

  @override
  State<AplyyMISModern2Screen> createState() => _AplyyMISModern2ScreenState();
}

class _AplyyMISModern2ScreenState extends State<AplyyMISModern2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyMISModern3Screen);
                              }
                            }),
                      ),
                      SizedBox(
