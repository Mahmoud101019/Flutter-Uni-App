...
class AplyyCsModern2Screen extends StatefulWidget {
  AplyyCsModern2Screen({super.key});

  @override
  State<AplyyCsModern2Screen> createState() => _AplyyCsModern2ScreenState();
}

class _AplyyCsModern2ScreenState extends State<AplyyCsModern2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyCsModern3Screen);
                              }
                            }),
                      ),
                      SizedBox(
