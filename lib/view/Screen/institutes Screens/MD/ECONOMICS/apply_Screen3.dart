...
class AplyyEcModern3Screen extends StatelessWidget {
  const AplyyEcModern3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("DEPARTEMRNT OF ECONOMICS"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyEcModern3Screen);
                        },
                        onConfirm: () {
