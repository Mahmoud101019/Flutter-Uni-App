...
class AplyyEcModern2Screen extends StatefulWidget {
  AplyyEcModern2Screen({super.key});

  @override
  State<AplyyEcModern2Screen> createState() => _AplyyEcModern2ScreenState();
}

class _AplyyEcModern2ScreenState extends State<AplyyEcModern2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyEcModern3Screen);
                              }
                            }),
                      ),
                      SizedBox(
