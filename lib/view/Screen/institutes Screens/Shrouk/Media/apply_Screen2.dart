...
class AplyyMediaScreenShrouk2Screen extends StatefulWidget {
  AplyyMediaScreenShrouk2Screen({super.key});

  @override
  State<AplyyMediaScreenShrouk2Screen> createState() => _AplyyMediaScreenShrouk2ScreenState();
}

class _AplyyMediaScreenShrouk2ScreenState extends State<AplyyMediaScreenShrouk2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyMediaScreenShrouk3Screen);
                              }
                            }),
                      ),
                      SizedBox(
