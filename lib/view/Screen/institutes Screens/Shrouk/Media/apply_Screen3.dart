...
class AplyyMediaScreenShrouk3Screen extends StatelessWidget {
  const AplyyMediaScreenShrouk3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Higher Institute of Media"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyMediaScreenShrouk3Screen);
                        },
                        onConfirm: () {
