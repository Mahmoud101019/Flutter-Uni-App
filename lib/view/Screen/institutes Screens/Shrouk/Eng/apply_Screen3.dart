...
class AplyyENGShrouk3Screen extends StatelessWidget {
  const AplyyENGShrouk3Screen({super.key});
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Higher Institute of Engineering"),
          centerTitle: true,
        ),
        body: Column(
                ...
                child: AuthButton(
                    ...
                    onPressed: () {
                      Get.defaultDialog(
                        ...
                        onCancel: () {
                          Get.toNamed(Routes.AplyyENGShrouk3Screen);
                        },
                        onConfirm: () {
