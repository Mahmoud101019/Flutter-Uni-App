...
class AplyyENGShrouk2Screen extends StatefulWidget {
  AplyyENGShrouk2Screen({super.key});

  @override
  State<AplyyENGShrouk2Screen> createState() => _AplyyENGShrouk2ScreenState();
}

class _AplyyENGShrouk2ScreenState extends State<AplyyENGShrouk2Screen> {
                        ...
                        child: AuthButton(
                            ...
                            onPressed: () {
                              if (Formkey.currentState!.validate()) {
                                ...
                                Get.offNamed(Routes.AplyyENGShrouk3Screen);
                              }
                            }),
                      ),
                      SizedBox(
